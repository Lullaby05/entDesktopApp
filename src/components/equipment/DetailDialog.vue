        ...
        <a-row :gutter="8">
          ...
          <a-col :span="12">
            <a-form-item label="设备铭牌图片" field="namePlat">
              <a-badge
                :count="
                  form.namePlat === '' || !form.namePlat
                    ? 0
                    : form.namePlat?.split(',').length
                "
              >
                <a-tag
                  :style="tagStyle"
        ...
        <a-row :gutter="8">
          <a-col :span="12">
            <a-form-item label="设备附件" field="accessory">
              <a-badge
                :count="
                  form.accessory === '' || !form.accessory
                    ? 0
                    : form.accessory?.split(',').length
                "
              >
                <a-tag
                  :style="tagStyle"
...
<script lang="ts" setup>
  ...
  import { typeList } from '@/api/equipment';
  ...
  const formDefault = ref<EquipmentFrom>({
    name: '',
    source: '',
    weight: '',
    status: '',
