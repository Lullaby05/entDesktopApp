<!--
*@fileName createDialog.vue
*@author wml
*@date 2023-06-15
*@description 设备设施创建页面
!-->
<template>
      ...
      <a-row :gutter="8">
        <a-col :span="12">
          <a-form-item label="设备图片" field="picture">
            <a-badge
              :count="form.picture === '' ? 0 : form.picture?.split(',').length"
            >
              <a-tag
                :style="tagStyle"
                bordered
        ...
        <a-col :span="12">
          <a-form-item label="设备铭牌图片" field="namePlat">
            <a-badge
              :count="
                form.namePlat === '' ? 0 : form.namePlat?.split(',').length
              "
            >
              <a-tag
                :style="tagStyle"
      ...
      <a-row :gutter="8">
        <a-col :span="12">
          <a-form-item label="设备附件" field="accessory">
            <a-badge
              :count="
                form.accessory === '' ? 0 : form.accessory?.split(',').length
              "
            >
              <a-tag
                :style="tagStyle"
