    ...
    computed: {
      ...
      statusIcon() {
        switch (this.status) {
          ...
          case 'pending':
            return 'pending iconfont2 icon-dengdaizhongbeifen';
          case 'success':
            return 'el-icon-successfilled success';
          case 'cc':
            return 'el-icon-promotion cc';
          case 'comment':
            return 'comment iconfont2 icon-xiaoxi';
          case 'transfer':
            return 'transfer iconfont2 icon-zhuanyi';
          case 'cancel':
            return 'cancel iconfont2 icon-fanhui-chehui-06';
          case 'recall':
            return 'recall iconfont2 icon-quxiao';
          case 'leader':
