...
<template>
  <div class="container">
    <TableListCard>
      ...
      <template #primaryBtn>
        <a-button
          v-permission="'GroundCertificateAdd'"
          type="primary"
          @click="handleAdd"
        ...
        >
          ...
          <template #option="{ record }">
            <div>
              ...
              >
              <a-button
                v-permission="'GroundCertificateHandling'"
                type="text"
                size="mini"
...
<script lang="ts" setup name="GroundCertificateIndex">
  ...
  getWorkUnitList(operationTypeEnum.GROUND).then((res: any) => {
  ...
  getOperationTypeEnum(operationTypeEnum.GROUND).then((res) => {
  ...
  const getTableList = async () => {
    const { data } = await getCertificateList(operationTypeEnum.GROUND, {
      ...searchForm.value,
    });
    store.setCurrentOperationType(operationTypeEnum.GROUND);
