...
<template>
  <div class="container">
    <TableListCard>
      ...
      <template #primaryBtn>
        <a-button
          v-permission="'BrokenRoadCertificateAdd'"
          type="primary"
          @click="handleAdd"
        ...
        >
          ...
          <template #option="{ record }">
            <div>
              ...
              >
              <a-button
                v-permission="'BrokenRoadCertificateHandling'"
                type="text"
                size="mini"
...
<script lang="ts" setup name="BrokenRoadCertificateIndex">
  ...
  getWorkUnitList(operationTypeEnum.BROKENROAD).then((res: any) => {
  ...
  getOperationTypeEnum(operationTypeEnum.BROKENROAD).then((res) => {
  ...
  const getTableList = async () => {
    const { data } = await getCertificateList(operationTypeEnum.BROKENROAD, {
      ...searchForm.value,
    });
    store.setCurrentOperationType(operationTypeEnum.BROKENROAD);
