...
<script lang="ts" setup>
  ...
  const buttonList = computed<any>(() => {
    if (props.applyUserId != userStore.enterPriseUserId) return [];
          ...
          return [
            {
              ...
              text: '修改申请',
              type: 'primary',
              permission: store.currentOperationTypeNameSimple + 'Add',
            },
          ];
        }
          ...
          return [
            {
              ...
              text: '撤回申请',
              status: 'danger',
              permission: store.currentOperationTypeName + 'Withdrew',
            },
          ];
        }
          ...
          return [
            {
              ...
              text: '取消申请',
              status: 'danger',
              permission: store.currentOperationTypeName + 'Cancel',
            },
          ];
        }
      }
