...
<template>
  <div class="container">
    <TableListCard>
      ...
      <template #primaryBtn>
        <a-button
          v-permission="'TempElectricityCertificateAdd'"
          type="primary"
          @click="handleAdd"
        ...
        >
          ...
          <template #option="{ record }">
            <div>
              ...
              >
              <a-button
                v-permission="'TempElectricityCertificateHandling'"
                type="text"
                size="mini"
...
<script lang="ts" setup name="TempElectricityCertificateIndex">
  ...
  // getWorkUnitList(operationTypeEnum.TEMPELECTRICITY).then((res: any) => {
  //   operationCompanyDict.value = res.data;
  // });
  const fireStatusDict = ref<any>([]);
  getOperationTypeEnum(operationTypeEnum.TEMPELECTRICITY).then((res) => {
  ...
  const getTableList = async () => {
    ...
    store.setCurrentOperationType(operationTypeEnum.TEMPELECTRICITY);
