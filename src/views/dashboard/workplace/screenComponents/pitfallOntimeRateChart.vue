<template>
  <div class="pitfall-ontime-rate-container">
    <div class="pitfall-ontime-chart" ref="echartsRef"></div>
    <div class="description-text">
      <span class="rate-text">按时整改率</span>
    </div>
  </div>
</template>
<script lang="ts" setup>
  ...
  const currentData = computed<any>(() => {
    return (
      ...
      Math.round(data.value['riskGovern'].onTimeCorrectRate)
    );
  });
