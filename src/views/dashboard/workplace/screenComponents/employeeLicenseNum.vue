<template>
  <div class="employee-license-container">
    <img src="/src/assets/images/icon-员工证照数.png" alt="" />
    <div class="employee-license-content">
      <div class="employee-license-description"> 员工证照数 </div>
      <div class="employee-license-num"> {{ currentData.total.count }} </div>
    </div>
  </div>
</template>
<script lang="ts" setup>
  ...
  const currentData = computed<any>(() => {
    return {
      total: getCurrentByName(data.value, 'licenseCount'),
    };
  });
</script>
