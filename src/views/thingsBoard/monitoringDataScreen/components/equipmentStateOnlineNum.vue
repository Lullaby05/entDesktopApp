<!-- 在线设备 -->
<template>
  <div class="equipment-online-rate-container">
    <div class="equipment-online-chart" ref="echartsRef"> </div>
    <div class="description-text">
      <span class="rate-text">在线设备</span>
    </div>
  </div>
</template>
<script lang="ts" setup>
  ...
  const currentData = computed<any>(() => {
    ...
    const result = new Decimal(data.value.online)
      .div(total)
      .mul(100)
      .toNumber();
    return result;
...
<style lang="less" scoped>
  .equipment-online-rate-container {
    width: 11rem;
    height: 100%;
    display: flex;
    align-items: center;
