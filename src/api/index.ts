...
export const UploadPath =
  import.meta.env.VITE_API_BASE_URL + '/businessApi/business/upload/uploadFile';
...
// 获取文件访问路径
export function getFileUrlAPI(fileName: string) {
  return Axios({
    url: '/businessApi/business/upload/file?fileName=' + fileName,
    method: 'get',
  });
}
